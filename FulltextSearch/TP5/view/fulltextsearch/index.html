...
<div class="search">
	...
	<div class="s-bar">
	   <form target="_blank">
	   	<input type="hidden" name="s" value="/Fulltextsearch/Fulltextsearch/search">
		<input type="text" value="Search Template" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Search Template';}" name="q">
